...
const gridItems = [
  {
    ...
    alt: "Silver chains and jewelry on a dark marble plinth",
    offset: false,
  },
  {
    ...
    alt: "Stylish model wearing premium apparel with gold jewelry accents",
    offset: true,
  },
  {
    ...
    alt: "Essential jewelry pieces on a clean white tray",
    offset: false,
  },
];
...
export function CollectionsGrid() {
  return (
    <section className="py-16 sm:py-24 bg-[#f9f9f9] max-w-[1440px] mx-auto px-4 sm:px-8 md:px-16">
          ...
          <AnimatedSection key={item.title} delay={i * 0.15}>
            ...
            >
              ...
              <div className="absolute bottom-8 sm:bottom-12 left-0 right-0 flex justify-center">
                <span className="bg-white text-[#2d3435] px-7 sm:px-10 py-3.5 sm:py-5 uppercase tracking-[0.2rem] sm:tracking-[0.25rem] text-[0.65rem] sm:text-[0.7rem] font-bold group-hover:bg-[#2d3435] group-hover:text-white transition-all duration-300">
                  {item.title}
                </span>
              </div>
            </Link>
