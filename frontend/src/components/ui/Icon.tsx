 ...
 * Inline SVG icon set.
 *
 * Replaces the previous `material-symbols-outlined` spans — that font was
 * never loaded, so those icons rendered as the literal words "favorite",
 * "close", "location_on" and so on. Inlining costs nothing at runtime,
 * needs no network request, and inherits `currentColor`.
 *
...
interface IconProps {
  name: IconName;
  className?: string;
  /** Pixel size; defaults to 20. Use `className` for colour. */
  size?: number;
